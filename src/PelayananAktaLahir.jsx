            ...
            {jenisPelayanan === "lahirwni" && (
              <>
                ...
                <div>
                  <label className="flex justify-start text-sm font-medium text-gray-700">
                    {" "}
                    Upload Surat Kelahiran dari Rumah Sakit
                  </label>
                  <input
                    type="file"
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"
                ...
                <div>
                  <label className="flex justify-start text-sm font-medium text-gray-700">
                    {" "}
                    Upload Fotokopi Buku Nikah/Akta Pernikahan
                  </label>
                  <input
                    type="file"
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"
                ...
                <div>
                  <label className="flex justify-start text-sm font-medium text-gray-700">
                    {" "}
                    Upload Kartu Tanda Penduduk Saksi (2 Orang)
                  </label>
                  <input
                    type="file"
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"
            ...
            {jenisPelayanan === "lahirwna" && (
              <>
                <div>
                  <label className="flex justify-start text-sm font-medium text-gray-700">
                    {" "}
                    Upload Surat Keterangan Kelahiran dari Rumah Sakit
                  </label>
                  <input
                    type="file"
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"
                ...
                <div>
                  <label className="flex justify-start text-sm font-medium text-gray-700">
                    {" "}
                    Upload Akta Pernikahan Negara Asal
                  </label>
                  <input
                    type="file"
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"
                ...
                <div>
                  <label className="flex justify-start text-sm font-medium text-gray-700">
                    {" "}
                    Upload Fotokopi Kartu Tanda Penduduk Negara Asal
                  </label>
                  <input
                    type="file"
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"
            ...
            {jenisPelayanan === "hilang" && (
              <>
                <div>
                  <label className="flex justify-start text-sm font-medium text-gray-700">
                    {" "}
                    Upload Surat Keterangan Kehilangan dari kepolisian (Jika
                    Hilang)
                  </label>
                  <input
                    type="file"
                ...
                <div>
                  <label className="flex justify-start text-sm font-medium text-gray-700">
                    {" "}
                    Upload Akta Kelahiran Asli (Jika Rusak)
                  </label>
                  <input
                    type="file"
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"
